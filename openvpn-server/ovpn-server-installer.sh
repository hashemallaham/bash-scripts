#!/bin/bash
#
# Created By Eng. Hashem Allaham - Syria
...
Copyright (c) 2022-2023 Hashem Allaham
EOF
}
...
LimitNPROC=infinity" > /etc/systemd/system/openvpn-server@server.service.d/disable-limitnproc.conf
	...
	cp -r EasyRSA-3.0.8/* /etc/openvpn/server/easy-rsa/ 
	...
	(
		...
		chmod 777 /etc/openvpn/server/easy-rsa/easyrsa
		/etc/openvpn/server/easy-rsa/easyrsa --batch init-pki >/dev/null
		/etc/openvpn/server/easy-rsa/easyrsa --batch build-ca nopass >/dev/null 2>&1
		/etc/openvpn/server/easy-rsa/easyrsa --batch --days=3650 build-server-full server nopass >/dev/null 2>&1
		/etc/openvpn/server/easy-rsa/easyrsa --batch --days=3650 build-client-full "$client" nopass >/dev/null 2>&1
		/etc/openvpn/server/easy-rsa/easyrsa --batch --days=3650 gen-crl >/dev/null 2>&1
	)
